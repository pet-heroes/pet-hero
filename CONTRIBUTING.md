...
Since the project is constantly being updated with contributions of all sorts, it is important to establish ground rules as well as expectations. This helps to ensure the best possible experience for users of the application, as well as encourage a positive, helpful, and lively community of active contributors just like you!
...
1. `clone` your forked repository:
   ...
   ```shell
   $ git clone https://github.com/<YOUR-USERNAME>/pet-hero
   ```

1. Add a new remote that points to the original project so you can sync project changes with your local copy:

   ```shell
   $ git remote add upstream https://github.com/pet-heroes/pet-hero
   ```
...
[issues]: https://github.com/pet-heroes/pet-hero/issues
[pull-requests]: https://github.com/pet-heroes/pet-hero/pulls
[wiki]: https://github.com/pet-heroes/pet-hero/wiki
